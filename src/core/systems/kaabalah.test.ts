...
import { id, KaabalahTypes, MiscTypes, TarotTypes, WesternAstrologyTypes } from '../types';
...
describe('loadKaabalah', () => {
  ...
  it('should correctly load the colors', () => {
    ...
    expect(tree.related(id(KaabalahTypes.SPHERE, SPHERES.MALKUTH), MiscTypes.COLOR)).toHaveLength(1);
  });
  ...
  it('should correctly load the western astrology', () => {
    ...
    const path15 = id(KaabalahTypes.PATH, MELKITZEDEKI_PATHS.CHOKHMAH_TIPHARETH);
    expect(tree.related(path11, WesternAstrologyTypes.WESTERN_ELEMENT)).toHaveLength(1);
    expect(tree.related(path12, WesternAstrologyTypes.PLANET)).toHaveLength(1);
    expect(tree.related(path15, WesternAstrologyTypes.WESTERN_ZODIAC_SIGN)).toHaveLength(1);
  });
  ...
  it('should correctly unload the western astrology', () => {
    ...
    expect(tree.related(path11, WesternAstrologyTypes.WESTERN_ELEMENT)).toHaveLength(0);
    expect(tree.related(path12, WesternAstrologyTypes.PLANET)).toHaveLength(0);
    expect(tree.related(path15, WesternAstrologyTypes.WESTERN_ZODIAC_SIGN)).toHaveLength(0);
  });
  ...
  it('should correctly load the tarot', () => {
    ...
    expect(tree.related(id(KaabalahTypes.SPHERE, SPHERES.MALKUTH), TarotTypes.TAROT_ARK_ANNU)).toHaveLength(4);
    ...
    expect(tree.related(id(WesternAstrologyTypes.WESTERN_ELEMENT, WESTERN_ELEMENTS.FIRE), TarotTypes.TAROT_SUIT)).toHaveLength(1);
  });
  ...
  it('should correctly unload the tarot', () => {
    ...
    expect(tree.related(id(KaabalahTypes.SPHERE, SPHERES.MALKUTH), TarotTypes.TAROT_ARK_ANNU)).toHaveLength(0);
    ...
    expect(tree.related(id(WesternAstrologyTypes.WESTERN_ELEMENT, WESTERN_ELEMENTS.FIRE), TarotTypes.TAROT_SUIT)).toHaveLength(0);
  });
  ...
  it('should correctly load the bridge between colors and musical notes (colors first)', () => {
    ...
    const malkuthColors = tree.related(id(KaabalahTypes.SPHERE, SPHERES.MALKUTH), MiscTypes.COLOR)

    expect(malkuthColors).toHaveLength(1);

    const malkuthMusicalNote = tree.related(id(KaabalahTypes.SPHERE, SPHERES.MALKUTH), MiscTypes.MUSICAL_NOTE)

    expect(malkuthMusicalNote).toHaveLength(1);
    expect(tree.related(malkuthMusicalNote[0]?.id, MiscTypes.COLOR)).toHaveLength(1);
  });
  ...
  it('should correctly load the bridge between colors and western astrology (colors first)', () => {
    ...
    const hodColors = tree.related(id(KaabalahTypes.SPHERE, SPHERES.HOD), MiscTypes.COLOR);

    expect(hodColors).toHaveLength(1);

    const zodiacSign = tree.related(hodColors[0].id, WesternAstrologyTypes.WESTERN_ZODIAC_SIGN);
  ...
  it('should correctly load the bridge between music and western astrology (music first)', () => {
    ...
    const path15ZodiacSign = tree.related(id(KaabalahTypes.PATH, MELKITZEDEKI_PATHS.CHOKHMAH_TIPHARETH), WesternAstrologyTypes.WESTERN_ZODIAC_SIGN);

    expect(path15ZodiacSign).toHaveLength(1);

    const musicalNote = tree.related(path15ZodiacSign[0]?.id, MiscTypes.MUSICAL_NOTE);
