...
This lets downstream apps mute `Daath`, `Chokhmah`, and the other special spheres with the same single fill string and removes the need for app-side dual-fill or overlay workarounds.
