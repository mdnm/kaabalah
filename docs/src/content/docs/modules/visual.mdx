...
The visual module ships vector glyph definitions for zodiac signs, planets, and aspects as normalized primitive arrays. Each glyph is defined in a `-1…1` coordinate space and can be rendered at any size.
